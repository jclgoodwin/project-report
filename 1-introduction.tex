...
The broader field of argumentation theory encompasses fields such as law, philosophy and critical thinking, where similar notations, such as argument maps, are used \citep[pp.~3--6]{open1}. \todo{and \emph{other} similar notations are used in the same fields as GSN\ldots} 
...
In the area of argumentation, Dependable Computing's Argument Editor \todo{see footnote 1?} \ldots
