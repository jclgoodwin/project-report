...
for example, arguing the security of a system\cite{plop}, and validating computer simulations of biological models \cite{insilico}. 
...
\begin{figure}
  ...
  \caption{An example argument, from the GSN specification \cite{gsnstandard}]}
   \label{fig:example}
\end{figure}
