...
Coulomb's law is [analogous to] Newton's law, which describes the gravit ational force between two masses.
...
Springy, as distributed [online], consists of a layout algorithm implemented in JavaScript (springy.js) along with a  
